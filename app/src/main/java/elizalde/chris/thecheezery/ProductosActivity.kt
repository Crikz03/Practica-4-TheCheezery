...
class ProductosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var opcionMenu: String? = intent.getStringExtra("tipoMenu")
        val imgTipoProducto = intent.getIntExtra("imgTipoProducto", 0)

        val imgTipo: ImageView = findViewById(R.id.imgTipoProducto)
        if (imgTipoProducto != 0) {
            imgTipo.setImageResource(imgTipoProducto)
        }

        this.agregaProductos(opcionMenu)
